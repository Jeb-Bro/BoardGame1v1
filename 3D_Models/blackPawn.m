classdef blackPawn < handle
    ...
    methods
        ...
        function self = blackPawn(option)
            self.CreateModel();
        ...
        function CreateModel(self)
            L(1) = Link('d',0.046,'a',0,'alpha',0,'offset',0);
...
%             qrea = zeros(1,7);
        ...
        function PlotAndColourRobot(self)
                linkIndex = 1;
                [faceData, vertexData, plyData{linkIndex+1} ] = plyread(['bPawn.ply'],'tri'); %#ok<AGROW>
