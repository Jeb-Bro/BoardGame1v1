classdef blackRook < handle
    ...
    methods
        ...
        function self = blackRook(option)
            self.CreateModel();
        ...
        function CreateModel(self)
            L(1) = Link('d',0.043,'a',0,'alpha',0,'offset',0);
...
%             qrea = zeros(1,7);
        ...
        function PlotAndColourRobot(self)
                linkIndex = 1;
                [faceData, vertexData, plyData{linkIndex+1} ] = plyread(['bRook.ply'],'tri'); %#ok<AGROW>
