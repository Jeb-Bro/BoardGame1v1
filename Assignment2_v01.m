...
%% Default poses for bots
UR5_defaultp = UR5bot.model.fkine(UR5bot.jointDef);
% i5bot_defaultp = i5bot.model.fkine(i5bot.jointDef);
...
%% UR5 RMRC test
qPick = [194 3.6 70.2 11.4 181 79.2 0]*pi/180;
...
%% Chess move - https://lichess.org/study/5p8kTv22 Sicilian Defense: Open
