classdef whiteKing < handle
    ...
    methods
        ...
        function self = whiteKing(option)
            self.CreateModel();
        ...
        function CreateModel(self)
            L(1) = Link('d',0.071,'a',0,'alpha',0,'offset',0);
...
%             qrea = zeros(1,7);
        ...
        function PlotAndColourRobot(self)
                linkIndex = 1;
                [faceData, vertexData, plyData{linkIndex+1} ] = plyread(['wKing.ply'],'tri'); %#ok<AGROW>
